...
export class RecordingController {
  ...
  @Get('status')
  @ApiOperation({ summary: 'Get recording status', description: 'Retrieve current recording status for a project' })
  ...
  @ApiOperation({ summary: 'Start recording', description: 'Start traffic recording for a project' })
  @ApiParam({ name: 'projectId', description: 'Project identifier' })
