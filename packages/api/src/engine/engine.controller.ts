...
export class EngineController {
  ...
  @Get()
  @ApiOperation({
    summary: 'Get mock engine status',
    description: 'Retrieve current mock engine information and status',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    summary: 'Reset mock mappings',
    description: 'Reset all mock mappings in the engine',
  })
