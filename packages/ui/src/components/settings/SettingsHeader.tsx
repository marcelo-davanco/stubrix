...
import { Archive, Download, Upload, Settings, ChevronDown, Languages } from 'lucide-react'
        ...
        <div className="relative" ref={localeRef}>
          <button
            ...
            className={cn(
              ...
              localeOpen ? 'border-primary bg-primary/10' : 'border-white/10 hover:bg-white/8',
            )}
          >
            <Languages size={14} />
            <span className="min-w-[4.5rem] text-left">{currentLocale?.label}</span>
            <ChevronDown size={12} className={cn('text-text-secondary', localeOpen && 'rotate-180')} />
          </button>
          {localeOpen && (
                ...
                <li key={opt.value}>
                  <button
                    ...
                    className={cn(
                      ...
                      opt.value === locale ? 'bg-primary/20 text-primary' : 'text-text-primary',
                    )}
                  >
                    {opt.label}
                  </button>
