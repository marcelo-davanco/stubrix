            ...
            <div>
              ...
              <p className="text-xs text-text-secondary mt-0.5">
                <span className="line-through opacity-60">
                  {maskValue(entry.old_value, entry.key)}
                </span>
              ...
              <div className="flex items-center gap-2 mt-1">
                ...
                <span
                  className={`text-xs px-1.5 py-0.5 rounded font-medium ${SOURCE_BADGE[entry.source] ?? 'bg-white/10 text-text-secondary'}`}
                >
                  {entry.source}
                </span>
              </div>
